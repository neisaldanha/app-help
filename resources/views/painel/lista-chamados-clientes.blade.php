            ...
            <div class="panel panel-white">
                <div class="panel-heading clearfix">
                    <div class="form-group col-10">
                        <a href="{{url('painel/form-chamado')}}" class="btn btn-success"><i class="fa fa-user-plus"> Novo</i>
                        </a>
                    </div>
                </div>
                <div class="col-12">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" title="Visualizar" data-toggle="modal" data-target="#editar-{{$chamado->ID_CHAMADO}}" class="btn btn-success btn-xs"><i class="fa icon-pencil"></i></i></button>
                                                    <a title="Interação" href="{{url('painel/create-interacao',$chamado->ID_CHAMADO)}}" class="btn btn-primary btn-xs"><i class="fa fa-camera"></i></a>
                                            ...
                                            <div class="modal fade bs-example-modal-lg print_div" id="editar-{{$chamado->ID_CHAMADO}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                                ...
                                                                <div class="card-header">
                                                                    <div class="card-header p-2">
                                                                        <ul class="nav nav-pills">
                                                                            <li class="nav-item"><a class="btn btn-primary nav-link active" href="#activity-{{$chamado->ID_CHAMADO}}" data-toggle="tab">Chamado</a></li>
                                                                            <li class="nav-item"><a class="btn btn-warning nav-link" href="#timeline-{{$chamado->ID_CHAMADO}}" data-toggle="tab">Interação</a></li>
                                                                            <li class="nav-item"><a class="btn btn-info nav-link" href="#newInter-{{$chamado->ID_CHAMADO}}" data-toggle="tab">Nova Interação</a></li>
                                                                                            ...
                                                                                            <div class="col-12" id="accordion">
                                                                                                <div class="card card-primary card-outline">
                                                                                                    <a class="d-block w-100" data-toggle="collapse" href="#int-{{$inter->ID_INTERACAO_CHAMADO}}">
                                                                                                        <div class="card-header">
                                                                                                            <h4 class="card-title w-100">{{$inter->USU_LOGIN}}</h4>
                                                                                                        </div>
                                                                                                    </a>
