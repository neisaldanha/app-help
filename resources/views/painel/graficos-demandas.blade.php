...
<body>
	...
	<div class="page-inner">
        	...
        	<div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel info-box panel-white">
                        <div class="panel-body">
                            <div class="info-box-stats">
                                <p class="counter">{{$qtdEncerrados}}</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel info-box panel-white">
                        <div class="panel-body">
                            <div class="info-box-stats">
                                <p class="counter">{{$percente}}<sup style="font-size: 20px">%</sup></p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel info-box panel-white">
                        <div class="panel-body">
                            <div class="info-box-stats">
                                <p class="counter">{{$qtdSemAtendimmento}}</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel info-box panel-white">
                        <div class="panel-body">
                            <div class="info-box-stats">
                                <p class="counter">{{$qtdEmAtendimento}}</p>
        ...
        <script src="{{asset('plugin/pugins/jquery-blockui/jquery.blockui.js')}}"></script>
        ...
        <script src="{{asset('plugin/plugins/chartsjs/Chart.min.js')}}"></script>
