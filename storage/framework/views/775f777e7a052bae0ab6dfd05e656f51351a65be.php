...
<head>
    ...
    <!-- Title -->
    <title>FACISB | Diploma Digital</title>
    ...
    -->
        ...
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="logo-box">
                    <a href="<?php echo e(url('adm/home')); ?>" class="logo-text"><span>Diploma</span></a>
                </div><!-- Logo Box -->
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-user"></span>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="inbox-alt.html">Cadastro de Assinatura</a></li>
                            <li><a href="message-view.html">Fluxo de Assinaturas</a></li>
                    ...
                    <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-briefcase"></span>
                            <p>Diploma Digital</p><span class="arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li><a href="ui-alerts.html">Registrar Diploma</a></li>
                            <li><a href="<?php echo e(url('painel/list-formandos')); ?>">Consultar Diplomas</a></li>
                            <li><a href="ui-icons.html">Relatório de Diplomas</a></li>
                        </ul>
                    </li>
        ...
        <div class="page-inner">
            ...
            <div class="page-footer">
                <p class="no-s">2023 &copy; FACISB.</p>
            </div>
        </div><!-- Page Inner -->
...
</html><?php /**PATH C:\xampp\htdocs\app-diploma\resources\views/layout/adm.blade.php ENDPATH**/ ?>