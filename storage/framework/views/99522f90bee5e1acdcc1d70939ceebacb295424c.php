            ...
            <div class="col-md-4">
                ...
                <div class="panel panel-white">
                    <div class="panel-body">
                        ...
                        <h3 class="profile-username text-center"><?php echo e(isset($user) ? $user->USU_LOGIN  :'NOVO NOME'); ?></h3>
                        <p class="text-muted text-center"><?php if(isset($user)): ?> <?php if($nivel == 'A'): ?> Administrador <?php elseif($nivel == "C"): ?> Comum <?php elseif($nivel == "S"): ?> Supervisor <?php endif; ?> <?php endif; ?></p>
                    </div>
                    <!-- /.card-body -->
                </div>
            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="form-control select2" name="dpto" id="dpto">
                                    <?php $__currentLoopData = $dptos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dpto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(isset($user) && $user->ID_DPTO == $dpto->ID_DPTO ): ?>
                                            <option selected value="<?php echo e($user->ID_DPTO); ?>" ><?php echo e($dpto->DESCRICAO); ?></option>
                                        <?php else: ?>
...
<?php echo $__env->make('layout.adm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app-help\resources\views/adm/register-user.blade.php ENDPATH**/ ?>