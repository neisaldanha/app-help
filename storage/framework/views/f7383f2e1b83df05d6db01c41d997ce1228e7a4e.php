...
<head>
    ...
    <!-- Title -->
    <title>G.C | Login - Grau Certo</title>
            ...
            <div id="main-wrapper">
                <div class="row">
                    <div class="col-md-3 center">
                        <div class="login-box">
                            <a href="index.html" class="logo-name text-lg text-center">Sistema Help</a>
                            <p class="text-center m-t-md">Por favor, Entre no sistema.</p>
                            <form class="m-t-md" action="<?php echo e(url('auth/check')); ?>" method="post">
...
unset($__errorArgs, $__bag); ?></span>
                            ...
                            <p class="text-center m-t-xs text-sm">2023 &copy; Grau Certo.</p>
                        </div>
                    </div>
                </div><!-- Row -->
            </div><!-- Main Wrapper -->
...
<?php /**PATH C:\xampp\htdocs\app-help\resources\views/auth/login.blade.php ENDPATH**/ ?>